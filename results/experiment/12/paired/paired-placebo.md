...
**primary: all treatment repos (registered)** — n = 62, control 0.435, treatment 0.452, lift +1.61 pts (paired Wald 95% CI -3.9 to +7.1; bootstrap -3.2 to +8.1). Discordant pairs: treatment-only 2, control-only 1, McNemar exact p = 1.0. Flags differed on 16/62 tasks; memory retrieved on 30/62.
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| instructlab/instructlab | 30 | 0.533 | 0.567 | +3.33 | 2 | 1 | 1.0 | 16 | 30 |
