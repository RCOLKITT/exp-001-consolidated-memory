...
**primary: all treatment repos (registered)** — n = 62, control 0.435, treatment 0.435, lift +0.00 pts (paired Wald 95% CI +0.0 to +0.0; bootstrap +0.0 to +0.0). Discordant pairs: treatment-only 0, control-only 0, McNemar exact p = 1.0. Flags differed on 1/62 tasks; memory retrieved on 2/62.
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| instructlab/instructlab | 30 | 0.533 | 0.533 | +0.00 | 0 | 0 | 1.0 | 1 | 2 |
