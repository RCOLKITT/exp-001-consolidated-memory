...
**primary: all treatment repos (registered)** — n = 62, control 0.452, treatment 0.468, lift +1.61 pts (paired Wald 95% CI -1.5 to +4.8; bootstrap +0.0 to +4.8). Discordant pairs: treatment-only 1, control-only 0, McNemar exact p = 1.0. Flags differed on 23/62 tasks; memory retrieved on 30/62.
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| instructlab/instructlab | 30 | 0.567 | 0.600 | +3.33 | 1 | 0 | 1.0 | 23 | 30 |
