...
from phase0.verifier import AnthropicClient, CachedClient, Localizer, repo_file_tree
...
def make_pipeline(repo, tasks, args, cache_path):
    ...
    client = CachedClient(None if args.offline else AnthropicClient(), cache_path, offline=args.offline)
