...
| Model + stated training cutoff | draft (D16): Llama 3.3 70B Instruct, "data freshness December 2023" (Meta model card) -> gate 2023-12-31; provider + exact model id/quantisation: ______ ; fallback Llama 4 Maverick, "knowledge cutoff August 2024" -> gate 2024-08-31 |
